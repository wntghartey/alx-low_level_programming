...
/**
 * create_buffer - Assignes 1024 bytes for a buffer.
 ...
 * @argc: The number of arguments contibuted to the program.
 ...
 * If file_to cannot be bulit or written to - exit code 99.
